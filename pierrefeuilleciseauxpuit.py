...
while jouer == True:
    nbmanche += 1
    reponse1 = input("{nom} faîtes votre choix parmi (pierre, papier, ciseaux, puit): ".format(nom=nom1))
    if reponse1 != 'pierre' and reponse1 != 'feuille' and reponse1 != 'ciseaux' and reponse1 != 'puit':
            testreponse1 = False
            print("Je n'ai pas compris votre réponse")
            while testreponse1 == False :
                print("Joueur ", nom1)
                reponse1 = input(" faîtes votre choix parmi (pierre, feuille, ciseaux, puit): ")
                testreponse1 = True
                if reponse1 != 'pierre' and reponse1 != 'feuille' and reponse1 != 'ciseaux'and reponse2 != 'puit':
                    testreponse1 = False

    if question == 'O' :
        reponse2 = ['feuille','pierre','ciseaux', 'puit'][random.randint(0, 3)]

    if question == 'N':
        print("Joueur", nom2)
        reponse2 = input("faîtes votre choix parmi (pierre, feuille, ciseaux, puit): ")
        if reponse2 != 'pierre' and reponse2 != 'feuille' and reponse2 != 'ciseaux' and reponse2 != 'puit':
            testreponse2 = False
            print("Je n'ai pas compris votre réponse")
    ...
    if reponse1 == 'pierre' and reponse2 == 'feuille' or reponse1 == 'feuille' and reponse2 == 'ciseaux' or reponse1 == 'ciseaux' and reponse2 == 'pierre' or reponse1 == 'puit' and reponse2 == 'feuille':
        gagnant = nom2
        score1 = score1 + 0
        score2 = score2 + 1
      
    if reponse1 == 'pierre' and reponse2 == 'ciseaux' or reponse1 == 'feuille' and reponse2 == 'pierre' or reponse1 == 'ciseaux' and reponse2 == 'feuille' or reponse1 == 'puit' and reponse2 == 'ciseaux' or reponse1 == 'puit' and reponse2 == 'pierre' or reponse1 == 'feuille' and reponse2 == 'puit':
        gagnant = nom1
        score1 = score1 + 1
        score2 = score2 + 0
